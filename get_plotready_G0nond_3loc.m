...
README = "Data generated from 'get_plotready_G0nond_3loc.m'";
README = [README "Plot ready data, including AFTER qc 'ed'SS','A','ds','Sk'(scaling)"];
README = splitlines(README)';



save('/data1/bliu/data/plotready_G0_nond_3loc_2025','README','G0_nond','G0_nond_all','G0_model','ds','ds_all','ds_model','f','gof')
save('/data1/bliu/data/G0_nond_3loc_allsk_2025','README','SS','ds','A','Sk','kh')