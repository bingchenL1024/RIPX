...
README = ['xcorr(G2,G1) and normalized using Falk sum convention and also include variance'];

save('/data1/bliu/data/raw/CXT_ALL_norm_and_var.mat', 'CXT_ALL','CXT_ALL_var','README')
