...
[iss2_1] = get_3locs(SS2,1); 
[iss3_1] = get_3locs(SS3,1);
[iss4_1] = get_3locs(SS4,1);
...
%Grab wave height:
SS.Hs2(N,:) = SS2.Hs(iss2)';
SS.Hs3(N,:) = SS3.Hs(iss3)';
SS.Hs4(N,:) = SS4.Hs(iss4)';
...
README = "Data generated from 'get_SS_ds_3loc.m'";
README = [README "Include basic data from S.mat + directional spread (include 3 locations)"];
README = splitlines(README)';

save('/data1/bliu/data/SS_ds_3loc','README','SS','ds')