...
load(['/data1/bliu/data/Sky_WBfit_expo_',expo_name]);
...
%global badfit_tot
badfit_tot = length(bla2)+ length(bla3)+length(bla4);
...
save(['/data1/bliu/data/Sky_withWBfit_qced_',expo_name],'A','SS','Sky2_cutoff_runmean','Sky3_cutoff_runmean','Sky4_cutoff_runmean','magspec2','magspec3','magspec4','Skym2','Skym3','Skym4','ky2_cutoff','ky3_cutoff',"ky4_cutoff",'kym2','kym3','kym4', ...
