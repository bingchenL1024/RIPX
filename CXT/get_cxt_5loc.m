...
save('/data1/bliu/data/cxt_alongct_max_dxwidth_fitpara_qced_5loc','fitpara_5loc','t_decoscal_tot_5loc','tau_nond_fit','Dw_nond_tot_5loc','cFbr_para_nond_tot_5loc','tau_decoscale_nond_tot_5loc','G0_nond_tot_5loc','t_scale2_tot_5loc','t_nond_stats','t_scale_tot_5loc','x_nond_tot_5loc','head')


% %% function alread put it into separate code 
% 
% function [binmean,binstd] = bin_mean_xnond(x_nond_tot_5loc,t_decoscal_tot_5loc,t_scale2_tot_5loc)
% % this code calculate the binmean of tau_nond data
% x_mark = linspace(-0.75,-0.25,5);
% x_range = 0.025;
% 
% t_nond = t_decoscal_tot_5loc./t_scale2_tot_5loc;
% for xloc = 1:5
% binmean(xloc) = mean(t_nond((x_nond_tot_5loc>x_mark(xloc)-x_range & x_nond_tot_5loc<x_mark(xloc)+x_range)),'omitmissing');
% binstd(xloc) = std(t_nond((x_nond_tot_5loc>x_mark(xloc)-x_range & x_nond_tot_5loc<x_mark(xloc)+x_range)),'omitmissing');
% 
% end 
% end 