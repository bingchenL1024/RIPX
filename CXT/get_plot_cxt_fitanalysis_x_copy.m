...
% This code analysis a b c fit from fit of cxt using x as coordinate
% This is a copy from test from directly just changed from t to x so it's
% not the final version and it's just a test (Nov 4)
