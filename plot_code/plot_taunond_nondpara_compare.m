...
[tau_nond_stats.xmean,tau_nond_stats.binmean,tau_nond_stats.binstd] = bin_mean_taunondVSxnond(x_nond_tot_5loc,t_decoscal_tot_5loc,t_scale2_tot_5loc);
...
hold off
xlabel('$x/L_{sz}$','Interpreter','latex')
ylabel('$\tilde{\tau} = \hat{\tau} / \sqrt{H_{sb}/g}$','Interpreter','latex')
grid on 
niceplot_nobold(fig_fontsz)
