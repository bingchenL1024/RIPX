...
subplot(2,3,4)
scatter(h.slp2.^(0.5),a_tot.slp2,45,'filled')
hold on 
scatter(h.slp3.^(0.5),a_tot.slp3,45,'filled')
hold on 
scatter(h.slp4.^(0.5),a_tot.slp4,45,'filled')
niceplot(18)
xlabel('$\sqrt{h} (m^{1/2})$','interpreter','latex')
ylabel('a (m) (decay rate)')
legend('slp2','slp3','slp4')
xlim([0,inf])
ylim([0,inf])
...
subplot(2,3,5)
scatter(h.slp2.^(0.5),b_tot.slp2,45,'filled')
hold on 
scatter(h.slp3.^(0.5),b_tot.slp3,45,'filled')
hold on 
scatter(h.slp4.^(0.5),b_tot.slp4,45,'filled')
niceplot(18)
xlabel('$\sqrt{h} (m^{1/2})$','interpreter','latex')
ylabel('b (m) (oscillation freq)')
legend('slp2','slp3','slp4')
...
subplot(2,3,6)
scatter(h.slp2.^(0.5),c_tot.slp2,45,'filled')
hold on 
scatter(h.slp3.^(0.5),c_tot.slp3,45,'filled')
hold on 
scatter(h.slp4.^(0.5),c_tot.slp4,45,'filled')
niceplot(18)
xlabel('$\sqrt{h} (m^{1/2})$','interpreter','latex')
ylabel('c (phase shift)')
legend('slp2','slp3','slp4')
