...
clear
load('/data1/bliu/data/plotready_G0_nond_3loc_2025')
load('/data1/bliu/data/G0_nond_3loc_allsk_2025')
%%%%%%%%%%%%%%%%%%%%%%%%%
g = 9.81;
...
ds_all = [repmat(ds.sigtb2',3,1);repmat(ds.sigtb3',3,1);repmat(ds.sigtb4',3,1)];
...
README = "Data generated from 'get_plotready_ky0nond_3loc.m'";
README = [README "Plot ready data, including AFTER qc 'ed'SS','A','ds','sk_ky0'(ky0 scaling)"];
README = splitlines(README)';


save('/data1/bliu/data/plotready_ky0_nond_3loc_2025','README','ky0_nond','ky0_nond_all','ds','ds_all','ds_model','ky0_model','f','gof')
